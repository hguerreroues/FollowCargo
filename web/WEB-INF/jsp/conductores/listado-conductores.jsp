<%@page contentType="text/html" pageEncoding="UTF-8" %>
  <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
      ...
      <!--  Data tables -->
      <link
        href="https://cdn.datatables.net/v/bs5/jszip-3.10.1/dt-2.1.8/b-3.2.0/b-colvis-3.2.0/b-html5-3.2.0/b-print-3.2.0/datatables.min.css"
        rel="stylesheet">
    ...
    <body>
              ...
              <div class="card-body">
                ...
                <div class="header-section">
                  <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title fw-semibold">Listado de Conductores</h5>
                    <div>
                        <a href="dashboard" class="btn btn-secondary me-2">
                            <i class="ti ti-arrow-left"></i> Dashboard
                        </a>
                        <a href="conductores-form?id=add" class="btn btn-primary">
                          <i class="ti ti-plus"></i> Nuevo Conductor
                        </a>
                    </div>
                ...
                <div class="table-section">
                  ...
                  <div id="noRecordsMessage" class="no-records-message" style="display: none;">
                    ...
                    <p>Agrega un nuevo conductor usando el botón "Nuevo Conductor"</p>
                </div>

                  <!-- Tabla (se mostrará/ocultará según haya registros) -->
                  <table id="conductoresTable" class="table table-striped" style="width: 100%">
                    <thead>
                        <tr>
                            <th></th>
                            <th>#</th>
      ...
      <!-- Scripts -->
      <script src="assets/js/conductores/conductores-list.js"></script>
      <!-- Menu-->
      ...
      <script
        src="https://cdn.datatables.net/v/bs5/jszip-3.10.1/dt-2.1.8/b-3.2.0/b-colvis-3.2.0/b-html5-3.2.0/b-print-3.2.0/datatables.min.js"></script>
